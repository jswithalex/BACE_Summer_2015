...
+ The only hard pre-requisites for this course are familiarity with the internet and using a web browser.

+ With that said, you will need a working knowledge of HTML and CSS to get the most out of this course (i.e., you should know how to put HTML elements on a page and style them with CSS).  If you don't know HTML and CSS at the start of the course, make sure to use the first three weeks to catch up, as we will be solely devoting our time to learning JavaScript then.  I recommend [Shay Howe's website] (http://learn.shayhowe.com) for a comprehensive and practical guide to HTML and CSS.
