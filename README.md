...
This class will teach you the fundamentals of JavaScript and help you develop the skills to build page widgets and add logic-based functionality to your HTML and CSS webpages.  
...
+ With that said, you will need a working knowledge of HTML and CSS to get the most out of this course.  You should know how to put HTML elements on a page and apply basic styles with CSS.  If you don't know HTML and CSS at the start of the course, make sure to use the first three weeks to catch up, as we will be solely devoting our time to learning JavaScript then.  I recommend [Shay Howe's website] (http://learn.shayhowe.com) for a comprehensive and practical guide to HTML and CSS.
